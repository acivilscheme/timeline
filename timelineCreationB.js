//Will eventually have to gather data from database to make persistant, for now using JSON

//One day change appendUI to each object instead of having their parent do it. The object should do it itself

//Can eventually have a popup textbox that lets you paste in JSON data then fill the timeline. 
//Call a function and have to display errors if the data isn't correct
...
var admin = new User("Administrator");
      ...
      "year": [
        {
          ...
          "event": [
            {
              "title": "Bingley Arrives",
              "synopsis": "Bingley arrives in Netherfield",
              "character": [
                {
                  "name": "Mr. Bingley",
                  "thoughts": ""
            ...
            {
              "title": "Bingley holds a Ball",
              "synopsis": "Darcy insults Elizabeth at the Meryton Ball",
              "character": [
                {
                  "name": "Mr. Darcy",
                  "thoughts": "He is being rude"
                },
                {
                  "name": "Elizabeth",
                  "thoughts": "She is insulted"
                }
              ]
            },
            {
              "title": "Bingley sees Jane",
              "synopsis": "Jane and Bingley attracted to each other",
              "character": [
                {
                  "name": "Mr. Bingley",
                  "thoughts": ""
        ...
        },
        {
          ...
          "event": [
            {
              "title": "Jane goes to Netherfield",
              "synopsis": "Jane visits Netherfield and stays back because she falls ill",
              "character": [
                {
                  "name": "Jane",
                  "thoughts": ""
            ...
            {
              "title": "Elizabeth goes to Netherfield",
              "synopsis": "Elizabeth goes to Netherfield to be with Jane",
              "character": [
                {
                  "name": "Elizabeth",
                  "thoughts": "Upset at her mother for pushing Jane"
                }
              ]
            }
          ]
